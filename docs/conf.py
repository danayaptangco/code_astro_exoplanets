...
import os
import sys
sys.path.insert(0, os.path.abspath('../planetsim/'))

project = 'planetsim'
copyright = '2026, Evelyn Bruinsma, Dana Yaptangco, Helena Buschermohle'
author = 'Evelyn Bruinsma, Dana Yaptangco, Helena Buschermohle'
release = '0.0.1'
root_doc = 'index'
